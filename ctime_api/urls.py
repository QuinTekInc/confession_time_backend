...
urlpatterns = [
    ...
    path('add-msg/recv=<str:recv_username>', views.addConfession),
    ...
    path('update-saved-user-detail/<str:savedUserID>', views.updateSavedUser),
    ...
    path('report-confession/', views.reportConfession)
]